...
<article class="fp-pickup js-fp-pickup-slider swiper">
    <div class="fp-pickup__wrapper swiper-wrapper"><a class="fp-pickup__item swiper-slide" href="#product1">
            ...
            <picture class="fp-pickup__picture"><img class="fp-pickup__picture-body" src="<?= $images ?>pickup-item-01.webp" alt="" width="320" height="320" loading="lazy" /></picture>
        </a><a class="fp-pickup__item swiper-slide" href="#product2">
            <div class="fp-pickup__inner">
                <div class="fp-pickup__text">
                    <p class="fp-pickup__sub-text">浜中町指定牧場</p>
            ...
            <picture class="fp-pickup__picture"><img class="fp-pickup__picture-body" src="<?= $images ?>pickup-item-04.webp" alt="" width="320" height="320" loading="lazy" /></picture>
        </a><a class="fp-pickup__item swiper-slide" href="#product3">
            <div class="fp-pickup__inner">
                <div class="fp-pickup__text">
                    <p class="fp-pickup__sub-text">浜中町指定牧場</p>
            ...
            <picture class="fp-pickup__picture"><img class="fp-pickup__picture-body" src="<?= $images ?>pickup-item-02.webp" alt="" width="320" height="320" loading="lazy" /></picture>
        </a><a class="fp-pickup__item swiper-slide" href="#product4">
            <div class="fp-pickup__inner">
                <div class="fp-pickup__text">
                    <p class="fp-pickup__sub-text">浜中町指定牧場</p>
            ...
            <picture class="fp-pickup__picture"><img class="fp-pickup__picture-body" src="<?= $images ?>pickup-item-03.webp" alt="" width="320" height="320" loading="lazy" /></picture>
        </a><a class="fp-pickup__item swiper-slide" href="#product5">
            <div class="fp-pickup__inner">
                <div class="fp-pickup__text">
                    <p class="fp-pickup__main-text">摩訶不思議スイーツ<br>パリネル</p>
                </div>
            </div>
            <picture class="fp-pickup__picture"><img class="fp-pickup__picture-body" src="<?= $images ?>pickup-item-05.webp" alt="" width="320" height="320" loading="lazy" /></picture>
        </a><a class="fp-pickup__item swiper-slide" href="#product6">
            <div class="fp-pickup__inner">
                <div class="fp-pickup__text">
                    <p class="fp-pickup__main-text">北海道<br>シューラスク</p>
                </div>
            </div>
            <picture class="fp-pickup__picture"><img class="fp-pickup__picture-body" src="<?= $images ?>pickup-item-06.webp" alt="" width="320" height="320" loading="lazy" /></picture>
        </a><a class="fp-pickup__item swiper-slide" href="#product7">
            <div class="fp-pickup__inner">
                <div class="fp-pickup__text">
                    <p class="fp-pickup__main-text">北海道<br>バターガレット</p>
                </div>
            </div>
            <picture class="fp-pickup__picture"><img class="fp-pickup__picture-body" src="<?= $images ?>pickup-item-07.webp" alt="" width="320" height="320" loading="lazy" /></picture>
        </a><a class="fp-pickup__item swiper-slide" href="#product8">
            <div class="fp-pickup__inner">
                <div class="fp-pickup__text">
            ...
            <picture class="fp-pickup__picture"><img class="fp-pickup__picture-body" src="<?= $images ?>pickup-item-08.webp" alt="" width="320" height="320" loading="lazy" /></picture>
        </a><a class="fp-pickup__item swiper-slide" href="#product8">
            <div class="fp-pickup__inner">
                <div class="fp-pickup__text">
            ...
            <picture class="fp-pickup__picture"><img class="fp-pickup__picture-body" src="<?= $images ?>pickup-item-09.webp" alt="" width="320" height="320" loading="lazy" /></picture>
        </a></div>
</article>
            ...
            <div class="fp-news__body js-inview">
                <ul class="fp-news__list">
                    <li class="fp-news__item"><a class="fp-news__link">
                            <p class="fp-news__date">2023.03.10</p>
                            <p class="fp-news__desc">sweets garden Prateriaとしてサイトをリニューアルしました。</p>
                        </a></li>
                    <li class="fp-news__item"><a class="fp-news__link">
                            <p class="fp-news__date">2023.01.18</p>
                            <p class="fp-news__desc">sweets garden Prateriaオープンしました。</p>
                        </a></li>
                </ul>
            </div>
        </div>
        ...
        <article class="fp-modal__article">
            ...
            <div class="fp-modal__detail">
                ...
                <dl class="fp-modal__price">
                    ...
                    <dd class="fp-modal__price-body"><span class="fp-modal__price-num">430</span><span>円（税込）</span></dd>
                </dl>
